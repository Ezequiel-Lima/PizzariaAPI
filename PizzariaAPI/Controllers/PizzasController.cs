...
namespace PizzariaAPI.Models
{
    ...
    {
        private readonly PizzariaAPIContext _context;

        public PizzasController(PizzariaAPIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Pizza>> PostPizza(Pizza pizza)
        {
          if (_context.Pizza == null)
          {
              return Problem("Entity set 'PizzariaAPIContext.Pizza'  is null.");
          }
